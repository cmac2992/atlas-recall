...
import { getFilteredCountries } from "./countryComboboxUtils";

export const DesktopCountryCombobox = forwardRef<
  CountryComboboxHandle,
  CountryComboboxProps
>(function DesktopCountryCombobox(
  {
    countries,
    disabled = false,
    onInputFocusChange,
  ...
  const filteredCountries = useMemo(
    () => getFilteredCountries(countries, query),
    [countries, query]
  );
